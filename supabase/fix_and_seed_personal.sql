-- ============================================================
-- LEVE ERP — Ajuste de Estrutura e Template Personal
-- ============================================================

-- 1. Adicionar coluna faltante
ALTER TABLE public.faturamento_query_templates 
    ADD COLUMN IF NOT EXISTS exemplo_parametros JSONB DEFAULT '{}'::jsonb;

-- 2. Inserir Template Personal
